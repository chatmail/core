...
pub enum ChatListItemFetchResult {
    ...
    ChatListItem {
        ...
        /// Deprecated alias for is_out_broadcast_channel
        is_broadcast: bool,
        /// true if the chat type is OutBroadcastChannel
        is_out_broadcast_channel: bool,
...
pub(crate) async fn get_chat_list_item_by_id(
    ...
    Ok(ChatListItemFetchResult::ChatListItem {
        ...
        is_broadcast: chat.get_type() == Chattype::OutBroadcastChannel,
        is_out_broadcast_channel: chat.get_type() == Chattype::OutBroadcastChannel,
        dm_chat_contact,
        was_seen_recently,
