...
Keys (and corresponding contacts)
obtained using [SecureJoin](https://securejoin.readthedocs.io)
protocol are considered "verified".
...
to the Autocrypt-Gossip header to indicate
that they have the gossiped key
